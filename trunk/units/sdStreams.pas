...
type
  TBytesArray = array[0..1073741823] of byte;
...
begin
  ...
  begin
    Move(TBytesArray(Buffer)[Idx], FRawBuffer[FRawPosition], FChunkSize - FRawPosition);
  ...
  // copy the raw buffer
  Move(TBytesArray(Buffer)[Idx], FRawBuffer[FRawPosition], Siz);
